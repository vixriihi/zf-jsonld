 ...
 * - HAL resources
 */
class JsonLDRenderer extends JsonRenderer
{
    /**
     ...
     *
     * Also ensures that the 'JsonLD' helper is present.
     *
    ...
    {
        if (!$nameOrModel instanceof JsonLDModel) {
            return parent::render($nameOrModel, $values);
        }

        if ($nameOrModel->isEntity()) {
            $helper  = $this->helpers->get('JsonLD');
